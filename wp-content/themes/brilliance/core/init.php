...
if(!function_exists('cpotheme_setup')){
	...
	function cpotheme_setup(){
		...
		add_theme_support('custom-background', array('default-color' => apply_filters('cpotheme_background_color', 'ffffff')));
...
if(!function_exists('cpotheme_scripts_front')){
	...
	function cpotheme_scripts_front( ){
		...
		wp_register_script('cpotheme_prettyphoto', $scripts_path.'jquery-prettyphoto.js', array(), false, true);
		wp_register_script('cpotheme_general', $scripts_theme_path.'general.js', array('jquery'), false, true);
	}
}
