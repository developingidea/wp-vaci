...
function cpocore_metabox_slide($post){
	cpotheme_meta_message(sprintf(__('Upgrade to %s to control the position, color, and appearance of slides.', 'cpocore'), '<a target="_blank" href="'.CPOTHEME_PREMIUM_URL.'">'.CPOTHEME_PREMIUM_NAME.'</a>'));
}
function cpocore_metabox_feature($post){
	cpotheme_meta_fields($post, cpotheme_metadata_feature_options());
	cpotheme_meta_message(sprintf(__('Upgrade to %s to control the linking of feature blocks.', 'cpocore'), '<a target="_blank" href="'.CPOTHEME_PREMIUM_URL.'">'.CPOTHEME_PREMIUM_NAME.'</a>'));
}
...
function cpocore_metabox_product($post){
	...
	cpotheme_meta_message(sprintf(__('Upgrade to %s to control the layout of products.', 'cpocore'), '<a target="_blank" href="'.CPOTHEME_PREMIUM_URL.'">'.CPOTHEME_PREMIUM_NAME.'</a>'));
}
function cpocore_metabox_service($post){
	cpotheme_meta_fields($post, cpotheme_metadata_service_options());
	cpotheme_meta_message(sprintf(__('Upgrade to %s to control the layout of services.', 'cpocore'), '<a target="_blank" href="'.CPOTHEME_PREMIUM_URL.'">'.CPOTHEME_PREMIUM_NAME.'</a>'));
}
...
function cpocore_metabox_team($post){
	cpotheme_meta_message(sprintf(__('Upgrade to %s to add descriptions and extra fields to team members.', 'cpocore'), '<a target="_blank" href="'.CPOTHEME_PREMIUM_URL.'">'.CPOTHEME_PREMIUM_NAME.'</a>'));
}
